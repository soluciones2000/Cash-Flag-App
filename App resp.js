...
export default class CashFlag extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      token:'836410fd39f3eb950f77bf7374f17fac0cb2fa4f68d69f4555886280563d1855',
      socio: '',
      oCupones: [],
      oPrepagos: [],
      oGiftcards: []
  ...
  fetchData() {
      fetch(PRODUCTS_URL+'email='+this.state.email+'&token='+this.state.token)
      .then((response) => response.json())
      .then((responseData) => {
        this.setState({ socio : responseData.socio });
        this.setState({ oCupones : responseData.cupones });
        this.setState({ oPrepagos: responseData.prepagos });
        this.setState({ oGiftcards: responseData.giftcards });
      });
  }
                        ...
                        >
                          <View style={{flexDirection: 'row', height: '100%'}}>
                            ...
                            >
                              <Text>
                                Cupón: 
                                  <Text style={{ marginLeft: 5, fontWeight: 'bold' }}>{item.cuponlargo}
                                  </Text>
                              </Text>
                              <Text>
                              ...
                              <Text style={{ fontWeight: 'bold', color: 'red' }}>{item.premio}</Text>
                              <Text>Vencimiento:
                                <Text style={{ marginLeft: 5, fontWeight: 'bold' }}>{item.fechavencimiento}
                                </Text>
                              </Text>
                            </View>
                          </View>
